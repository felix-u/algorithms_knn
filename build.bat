...
set cl_link=-link -entry:entrypoint -subsystem:console -incremental:no kernel32.lib
set clang_link=-lkernel32 -Xlinker -entry:entrypoint -Xlinker -subsystem:console
